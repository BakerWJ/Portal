...
class SetUp4ViewController: UIViewController, UITextFieldDelegate{
    ...
    @IBAction func isClicked(_ sender: Any) {
        ...
        variableName.update(ADay: true, flipped: false, classnumber: 4, newValue: monday.text ?? "Period 4")
        variableName.update(ADay: false, flipped: false, classnumber: 4, newValue: tuesday.text ?? "Period 4")
    }
    /*
    // MARK: - Navigation
